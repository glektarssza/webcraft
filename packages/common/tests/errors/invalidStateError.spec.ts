    ...
    describe('.InvalidStateError', () => {
        describe('.constructor()', () => {
            ...
            it('should pass a default message on to the base class', () => {
                ...
                //-- When
                const e = new InvalidStateError(operationName, objectType);
            ...
            it('should set the `objectType` property to the provided value', () => {
                //-- Given
                const operationName = faker.lorem.word();
                const objectType = faker.lorem.word();
                const message = faker.lorem.sentence();
            ...
            it('should set the `name` property to `InvalidStateError`', () => {
                //-- Given
                const operationName = faker.lorem.word();
                const objectType = faker.lorem.word();
                const message = faker.lorem.sentence();
